...
func InstallServiceFlags(flags *pflag.FlagSet, serviceName string, serviceDisplayName string) {
	flServiceName = flags.String("service-name", serviceName, "Set the Windows service name")
	flServiceDisplayName = flags.String("service-displayname", serviceDisplayName, "Set the Windows service display name")
	...
	flRunService = flags.Bool("run-service", false, "Start the service before exiting")
